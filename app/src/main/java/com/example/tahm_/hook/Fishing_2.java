...
public class Fishing_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_2);
    ...
    public void next() {
        Intent next = new Intent(getApplicationContext(), Fishing_3.class);
