...
public class Fishing_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_5);
    ...
    public void next() {
        Intent next = new Intent(getApplicationContext(), Fishing_6.class);
