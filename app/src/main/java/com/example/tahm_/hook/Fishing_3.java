...
public class Fishing_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_3);
    ...
    public void next() {
        Intent next = new Intent(getApplicationContext(), Fishing_4.class);
