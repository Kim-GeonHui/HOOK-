...
public class Aquarium_tropical1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aquarium_tropical1);
    ...
    public void fish_check() {
        if (check_213==0) {
            ...
            ImageView image = (ImageView) findViewById(R.id.t_213);
            image.setImageDrawable(fish_image_1);
        }
        if (check_214==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_214);
            image.setImageDrawable(fish_image_1);
        }
        if (check_215==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_215);
            image.setImageDrawable(fish_image_1);
        }
        if (check_217==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_217);
            image.setImageDrawable(fish_image_1);
        }
        if (check_218==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_218);
            image.setImageDrawable(fish_image_1);
        }
    }
