...
public class Aquarium extends AppCompatActivity {
    ...
    public void onClick_button_t(View v) {
    ...
    public void onClick_button_b(View v) {
    ...
    public void onClick_button_s(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_swamp.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
