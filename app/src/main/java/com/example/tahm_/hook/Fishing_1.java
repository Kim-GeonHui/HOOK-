...
public class Fishing_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_1);
    ...
    public void next() {
        Intent next = new Intent(getApplicationContext(), Fishing_2.class);
