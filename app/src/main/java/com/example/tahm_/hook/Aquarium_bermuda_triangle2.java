...
public class Aquarium_bermuda_triangle2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aquarium_bermuda_triangle2);
    ...
    public void onClick_back(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_bermuda_triangle1.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
    ...
    public void fish_check() {
        if (check_303==0) {
            ...
            ImageView image = (ImageView) findViewById(R.id.b_303);
            image.setImageDrawable(fish_image_1);
        }
        if (check_304==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_304);
            image.setImageDrawable(fish_image_1);
        }
        if (check_307==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_307);
            image.setImageDrawable(fish_image_1);
        }
        if (check_309==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_309);
            image.setImageDrawable(fish_image_1);
        }
        if (check_390==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_390);
            image.setImageDrawable(fish_image_1);
        }
    }
