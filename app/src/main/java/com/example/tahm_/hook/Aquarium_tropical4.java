...
public class Aquarium_tropical4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aquarium_tropical4);
    ...
    public void fish_check() {
        if (check_211==0) {
            ...
            ImageView image = (ImageView) findViewById(R.id.t_211);
            image.setImageDrawable(fish_image_1);
        }
        if (check_212==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_212);
            image.setImageDrawable(fish_image_1);
        }
        if (check_216==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_216);
            image.setImageDrawable(fish_image_1);
        }
        if (check_290==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_290);
            image.setImageDrawable(fish_image_1);
        }
    }
