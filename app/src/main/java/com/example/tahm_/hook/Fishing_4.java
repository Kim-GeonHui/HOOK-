...
public class Fishing_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_4);
    ...
    public void next() {
        Intent next = new Intent(getApplicationContext(), Fishing_5.class);
