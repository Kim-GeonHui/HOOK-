...
public class Aquarium_bermuda_triangle1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aquarium_bermuda_triangle1);
    ...
    public void onClick_front(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_bermuda_triangle2.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
    ...
    public void fish_check() {
        if (check_300==0) {
            ...
            ImageView image = (ImageView) findViewById(R.id.b_300);
            image.setImageDrawable(fish_image_1);
        }
        if (check_301==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_301);
            image.setImageDrawable(fish_image_1);
        }
        if (check_302==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_302);
            image.setImageDrawable(fish_image_1);
        }
        if (check_305==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_305);
            image.setImageDrawable(fish_image_1);
        }
        if (check_308==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.b_308);
            image.setImageDrawable(fish_image_1);
        }
    }
