...
public class Fishing_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_6);
    ...
    public void next() {
        Intent next = new Intent(getApplicationContext(), Fishing_7.class);
