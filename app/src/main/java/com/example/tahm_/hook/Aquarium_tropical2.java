...
public class Aquarium_tropical2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aquarium_tropical2);
    ...
    public void onClick_front(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_tropical3.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
    ...
    public void onClick_back(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_tropical1.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
    ...
    public void fish_check() {
        if (check_205==0) {
            ...
            ImageView image = (ImageView) findViewById(R.id.t_205);
            image.setImageDrawable(fish_image_1);
        }
        if (check_206==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_206);
            image.setImageDrawable(fish_image_1);
        }
        if (check_207==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_207);
            image.setImageDrawable(fish_image_1);
        }
        if (check_208==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_208);
            image.setImageDrawable(fish_image_1);
        }
        if (check_210==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_210);
            image.setImageDrawable(fish_image_1);
        }
    }
