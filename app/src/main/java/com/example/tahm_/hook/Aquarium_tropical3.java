...
public class Aquarium_tropical3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aquarium_tropical3);
    ...
    public void onClick_front(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_tropical4.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
    ...
    public void onClick_back(View v) {
        Intent next = new Intent(getApplicationContext(), Aquarium_tropical2.class);
        next.putExtra("money", money);
        next.putExtra("rod_level", rod_level);
        next.putExtra("check_bait", check_bait);
        next.putExtra("count_bait_normal", count_bait_normal);
    ...
    public void fish_check() {
        if (check_200==0) {
            ...
            ImageView image = (ImageView) findViewById(R.id.t_200);
            image.setImageDrawable(fish_image_1);
        }
        if (check_201==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_201);
            image.setImageDrawable(fish_image_1);
        }
        if (check_202==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_202);
            image.setImageDrawable(fish_image_1);
        }
        if (check_203==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_203);
            image.setImageDrawable(fish_image_1);
        }
        if (check_204==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_204);
            image.setImageDrawable(fish_image_1);
        }
        if (check_209==0) {
            Drawable fish_image_1 = getResources().getDrawable(R.drawable.transparent);
            ImageView image = (ImageView) findViewById(R.id.t_209);
            image.setImageDrawable(fish_image_1);
        }
    }
